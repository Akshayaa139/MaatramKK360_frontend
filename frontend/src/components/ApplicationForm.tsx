...
const ApplicationForm: React.FC<ApplicationFormProps> = ({
  ...
  // Use watch to track form values if needed for conditional rendering
    ...
    switch (currentStep) {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                {errors.personalInfo?.aadharNumber && (
                  <p className="text-red-500 text-xs mt-1">
                    {errors.personalInfo.aadharNumber.message}
                  </p>
                )}
              </div>
            </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div>
                  ...
                  {errors.personalInfo?.address?.district && (
                    <p className="text-red-500 text-xs mt-1">
                      {errors.personalInfo.address.district.message}
                    </p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {errors.personalInfo?.address?.pincode && (
                    <p className="text-red-500 text-xs mt-1">
                      {errors.personalInfo.address.pincode.message}
                    </p>
                  )}
                </div>
              </div>
      ...
      case 1:
        return (
          <div className="space-y-6">
            <h3 className="text-lg font-semibold text-gray-900">
              {t("application.educationalInfo.title")}
            </h3>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  {errors.educationalInfo?.tenthBoard && (
                    <p className="text-red-500 text-xs mt-1">
                      {errors.educationalInfo.tenthBoard.message}
                    </p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {errors.educationalInfo?.tenthSchool && (
                    <p className="text-red-500 text-xs mt-1">
                      {errors.educationalInfo.tenthSchool.message}
                    </p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {errors.educationalInfo?.tenthYear && (
                    <p className="text-red-500 text-xs mt-1">
                      {errors.educationalInfo.tenthYear.message}
                    </p>
                  )}
                </div>
                ...
                <div>
                  ...
                  <input
                    {...register("educationalInfo.tenthPercentage", {
                      valueAsNumber: true,
                    })}
                    type="number"
                    step="0.01"
                  ...
                  {errors.educationalInfo?.tenthPercentage && (
                    <p className="text-red-500 text-xs mt-1">
                      {errors.educationalInfo.tenthPercentage.message}
                    </p>
                  )}
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  {errors.educationalInfo?.twelfthBoard && (
                    <p className="text-red-500 text-xs mt-1">
                      {errors.educationalInfo.twelfthBoard.message}
                    </p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {errors.educationalInfo?.twelfthSchool && (
                    <p className="text-red-500 text-xs mt-1">
                      {errors.educationalInfo.twelfthSchool.message}
                    </p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {errors.educationalInfo?.twelfthYear && (
                    <p className="text-red-500 text-xs mt-1">
                      {errors.educationalInfo.twelfthYear.message}
                    </p>
                  )}
                </div>
                ...
                <div>
                  ...
                  <input
                    {...register("educationalInfo.twelfthPercentage", {
                      valueAsNumber: true,
                    })}
                    type="number"
                    step="0.01"
                  ...
                  {errors.educationalInfo?.twelfthPercentage && (
                    <p className="text-red-500 text-xs mt-1">
                      {errors.educationalInfo.twelfthPercentage.message}
                    </p>
                  )}
                </div>
              </div>
              ...
              <div>
                ...
                {errors.educationalInfo?.preferredStream && (
                  <p className="text-red-500 text-xs mt-1">
                    {errors.educationalInfo.preferredStream.message}
                  </p>
                )}
              </div>
            </div>
      ...
      case 2:
        return (
          <div className="space-y-6">
            <h3 className="text-lg font-semibold text-gray-900">
              {t("application.familyInfo.title")}
            </h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                {errors.familyInfo?.fatherName && (
                  <p className="text-red-500 text-xs mt-1">
                    {errors.familyInfo.fatherName.message}
                  </p>
                )}
              </div>
              ...
              <div>
                ...
                {errors.familyInfo?.fatherOccupation && (
                  <p className="text-red-500 text-xs mt-1">
                    {errors.familyInfo.fatherOccupation.message}
                  </p>
                )}
              </div>
              ...
              <div>
                ...
                <input
                  {...register("familyInfo.fatherIncome", {
                    valueAsNumber: true,
                  })}
                  type="number"
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                ...
                {errors.familyInfo?.fatherIncome && (
                  <p className="text-red-500 text-xs mt-1">
                    {errors.familyInfo.fatherIncome.message}
                  </p>
                )}
              </div>
              ...
              <div>
                ...
                {errors.familyInfo?.motherName && (
                  <p className="text-red-500 text-xs mt-1">
                    {errors.familyInfo.motherName.message}
                  </p>
                )}
              </div>
              ...
              <div>
                ...
                {errors.familyInfo?.motherOccupation && (
                  <p className="text-red-500 text-xs mt-1">
                    {errors.familyInfo.motherOccupation.message}
                  </p>
                )}
              </div>
              ...
              <div>
                ...
                <input
                  {...register("familyInfo.motherIncome", {
                    valueAsNumber: true,
                  })}
                  type="number"
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                ...
                {errors.familyInfo?.motherIncome && (
                  <p className="text-red-500 text-xs mt-1">
                    {errors.familyInfo.motherIncome.message}
                  </p>
                )}
              </div>
              ...
              <div>
                ...
                {errors.familyInfo?.siblings && (
                  <p className="text-red-500 text-xs mt-1">
                    {errors.familyInfo.siblings.message}
                  </p>
                )}
              </div>
              ...
              <div>
                ...
                {errors.familyInfo?.familyType && (
                  <p className="text-red-500 text-xs mt-1">
                    {errors.familyInfo.familyType.message}
                  </p>
                )}
              </div>
            </div>
      ...
      case 3:
        return (
          <div className="space-y-6">
            <h3 className="text-lg font-semibold text-gray-900">
              {t("application.financialInfo.title")}
            </h3>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  {...register("financialInfo.annualFamilyIncome", {
                    valueAsNumber: true,
                  })}
                  type="number"
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                ...
                {errors.financialInfo?.annualFamilyIncome && (
                  <p className="text-red-500 text-xs mt-1">
                    {errors.financialInfo.annualFamilyIncome.message}
                  </p>
                )}
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  {errors.financialInfo?.bankDetails?.accountNumber && (
                    <p className="text-red-500 text-xs mt-1">
                      {errors.financialInfo.bankDetails.accountNumber.message}
                    </p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {errors.financialInfo?.bankDetails?.ifscCode && (
                    <p className="text-red-500 text-xs mt-1">
                      {errors.financialInfo.bankDetails.ifscCode.message}
                    </p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {errors.financialInfo?.bankDetails?.bankName && (
                    <p className="text-red-500 text-xs mt-1">
                      {errors.financialInfo.bankDetails.bankName.message}
                    </p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {errors.financialInfo?.bankDetails?.branchName && (
                    <p className="text-red-500 text-xs mt-1">
                      {errors.financialInfo.bankDetails.branchName.message}
                    </p>
                  )}
                </div>
              </div>
                ...
                <div>
                  ...
                  <div className="border-2 border-dashed border-gray-300 rounded-lg p-4 text-center hover:border-blue-400 transition-colors">
                    <input
                      ...
                      onChange={(e) =>
                        e.target.files?.[0] &&
                        handleFileUpload("tenthMarksheet", e.target.files[0])
                      }
                      className="hidden"
                      id="tenth-marksheet-upload"
                    />
                    <label
                      htmlFor="tenth-marksheet-upload"
                      className="cursor-pointer"
                    >
                      <div className="text-gray-600">
                        <svg
                        ...
                        <p className="mt-2 text-sm text-gray-500">
                          Click to upload 10th marksheet
                        </p>
                        <p className="text-xs text-gray-400">
                    ...
                    {uploadedFiles.tenthMarksheet && (
                      <p className="mt-2 text-sm text-green-600">
                        ✓ {uploadedFiles.tenthMarksheet.name}
                      </p>
                    )}
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="border-2 border-dashed border-gray-300 rounded-lg p-4 text-center hover:border-blue-400 transition-colors">
                    <input
                      ...
                      onChange={(e) =>
                        e.target.files?.[0] &&
                        handleFileUpload("twelfthMarksheet", e.target.files[0])
                      }
                      className="hidden"
                      id="twelfth-marksheet-upload"
                    />
                    <label
                      htmlFor="twelfth-marksheet-upload"
                      className="cursor-pointer"
                    >
                      <div className="text-gray-600">
                        <svg
                        ...
                        <p className="mt-2 text-sm text-gray-500">
                          Click to upload 12th marksheet
                        </p>
                        <p className="text-xs text-gray-400">
                          PDF, JPG, PNG up to 5MB
                        </p>
                    ...
                    {uploadedFiles.twelfthMarksheet && (
                      <p className="mt-2 text-sm text-green-600">
                        ✓ {uploadedFiles.twelfthMarksheet.name}
                      </p>
                    )}
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <div className="border-2 border-dashed border-gray-300 rounded-lg p-3 text-center hover:border-blue-400 transition-colors">
                    ...
                    />
                    <label
                      htmlFor="income-certificate-upload"
                ...
                <div>
                  ...
                  <div className="border-2 border-dashed border-gray-300 rounded-lg p-3 text-center hover:border-blue-400 transition-colors">
                    ...
                    />
                    <label
                      htmlFor="community-certificate-upload"
                      className="cursor-pointer text-sm text-gray-600"
                    >
                      Click to upload
                    </label>
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-lg">
      ...
      <form onSubmit={handleSubmit(onSubmitForm)} className="space-y-8">
        <div className="bg-gray-50 p-6 rounded-lg">{renderStepContent()}</div>
        ...
        <div className="flex justify-between">
          <button
            ...
            className={`px-6 py-2 rounded-md font-medium ${currentStep === 0
